...
export default function ProductCard({ id, name, description, image, price }: ProductCardProps) {
      ...
      >
        ...
        <div className="p-4">
          ...
          <div className="flex justify-between items-center mb-4">
            ...
            <Button onClick={() => router.push(`/umkm/${id}`)}>View Details</Button>
          </div>
        </div>
      </motion.div>
      <ImageModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} imageSrc={image} imageAlt={name} />
    </>
  )
}
